...
main:
		...
		movia r14, ZERO		#load ssd addresses
		movia r15, ONE
		movia r16, TWO
		movia r17, THREE
		movia r18, FOUR
		...
		movia r23, NINE
  		...
  		stbio r14, 0(r5)	#r5 points to the location of r14
...
DECREMENT:
		subi r5, r5, 4		#decrement to prior register

		br DISPLAY

INCREMENT:
		addi r5, r5, 4		#increment to next register

		br DISPLAY

DISPLAY:
		ldbio r6, 0(r5)		#load value from memory pointer
